...
namespace SQLHelper
{
    ...
    {
        public static readonly string default_connection_str = ConfigurationManager.ConnectionStrings["Conn"].ConnectionString;
        public static readonly string default_connection_str2 = ConfigurationManager.ConnectionStrings["Conn2"].ConnectionString;
        public static readonly string operaciones = ConfigurationManager.ConnectionStrings["operaciones"].ConnectionString;
        public static readonly string cnxSeguridad = ConfigurationManager.ConnectionStrings["ConnSeguridad"].ConnectionString;
        public static readonly string cnxTransportes = ConfigurationManager.ConnectionStrings["ConnTransportes"].ConnectionString;
        public static readonly string cnxAntaresLogistics = ConfigurationManager.ConnectionStrings["ConnAntares"].ConnectionString;
        //public static readonly string cnxPruebaTRANSPORTES = ConfigurationManager.ConnectionStrings["ConnAntaresTransportes"].ConnectionString;
        public static readonly string cnxTransportes_2 = ConfigurationManager.ConnectionStrings["ConnTransportes_2"].ConnectionString;
        public static readonly string CnxContrans = ConfigurationManager.ConnectionStrings["ConnContrans"].ConnectionString;
        public static readonly string CnxFepe = ConfigurationManager.ConnectionStrings["ConnFEPE"].ConnectionString;
