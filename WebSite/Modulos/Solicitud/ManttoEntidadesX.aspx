<%@ Page Language="C#" MasterPageFile="~/Templete.master" AutoEventWireup="true" CodeFile="ManttoEntidadesX.aspx.cs" Inherits="Modulos_Solicitud_ManttoEntidadesX" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
        ...
        <asp:View ID="View1" runat="server">
            ...
            <div id="z" tabindex="-1" role="dialog" class="modal fade">
                <%--<div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">
                        ...
                        <div class="modal-body">
                            <div class="text">
                                ...
                                <div class="form-group col-lg-6">
                                    <label for="userName">Nro. Documento :</label>
                                        ...
                                        <asp:RegularExpressionValidator 
                                                id="RegularExpressionValidatorNumeroDocumento" runat="SERVER" 
                                                ControlToValidate="txtNroDocumento" 
                                                ErrorMessage="Ingrese Dirección correctamente."
                                ...
                                <div class="form-group">
                                    <asp:Button ID="Button1" CssClass="btn btn-info m-t-5" runat="server" OnClick="lnkRegistrar_Click" Text="Guardar"></asp:Button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                             ...
                             <div class="text">
                                ...
                                <div class="form-group text-right">
                                    <asp:Button ID="Button2" CssClass="btn btn-info m-t-5" runat="server" OnClick="lnkRegistrar_Click" Text="Guardar"></asp:Button>
                                </div>
                            </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <label for="userName">Dirección</label>
                                        ...
                                        <asp:RegularExpressionValidator 
                                                ...
                                                ErrorMessage="Ingrese Dirección correctamente."
                                                ValidationExpression="^[a-zA-ZáéíúóÁÉÍÓÚ0-9. ]*$">
                                            </asp:RegularExpressionValidator>
                                    </div>
                                </div>
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-group col-lg-12">
                                        <label for="userName">Nombre :</label>
                                            ...
                                            <asp:RegularExpressionValidator 
                                                ...
                                                ControlToValidate="txtNombre" 
                                                ErrorMessage="Ingrese nombre correctamente."
                                                ValidationExpression="^[a-zA-ZáéíúóÁÉÍÓÚ ]*$">
                                            </asp:RegularExpressionValidator>
                                        </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    <div class="form-group col-lg-6">
                                        <label for="userName">Apellido Paterno :</label>
                                            ...
                                            <asp:RegularExpressionValidator 
                                                id="RegularExpressionValidatorApellidoPaterno" runat="SERVER" 
                                                ControlToValidate="txtApePaterno" 
                                                ErrorMessage="Ingrese Apellido correctamente."
                                                ValidationExpression="^[a-zA-ZáéíúóÁÉÍÓÚ ]*$">
                                            </asp:RegularExpressionValidator>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        <label for="userName">Apellido Materno :</label>
                                            ...
                                            <asp:RegularExpressionValidator 
                                                id="RegularExpressionValidatorApellidoMaterno" runat="SERVER" 
                                                ControlToValidate="txtApeMaterno" 
                                                ErrorMessage="Ingrese Apellido correctamente."
                                                ValidationExpression="^[a-zA-ZáéíúóÁÉÍÓÚ ]*$">
                                            </asp:RegularExpressionValidator>
                                        </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <label for="userName">Cargo :</label>
                                            ...
                                            <asp:RegularExpressionValidator 
                                                id="RegularExpressionValidatorCargo" runat="SERVER" 
                                                ControlToValidate="txtCargo" 
                                                ErrorMessage="Ingrese Cargo correctamente."
                                                ValidationExpression="^[a-zA-ZáéíúóÁÉÍÓÚ ]*$">
                                            </asp:RegularExpressionValidator>
                                    </div>                                  
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    <div class="form-group col-lg-6">
                                        <label for="userName" class="control-label">Teléfono :</label>
                                            ...
                                            <asp:RegularExpressionValidator 
                                                id="RegularExpressionValidatorTelefono" runat="SERVER" 
                                                ControlToValidate="txtTelefono"
                                                ErrorMessage="Ingrese Telefono correctamente."
                                    ...
                                    <div class="form-group col-lg-6">
                                        <label for="userName" class="control-label">Anexo :</label>
                                            ...
                                            <asp:RegularExpressionValidator 
                                                ...
                                                ControlToValidate="txtAnexo"
                                                ErrorMessage="Ingrese Anexo correctamente."
                                                ValidationExpression="^[0-9]*$">
                                            </asp:RegularExpressionValidator>
                                    </div>
                                </div>
