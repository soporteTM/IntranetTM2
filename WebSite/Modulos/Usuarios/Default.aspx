<%@ Page Language="C#" MasterPageFile="~/Templete.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Modulos_Usuarios_Default" %>
                    ...
                    <div class="card-box table-responsive">
                       ...
                       CssClass="table table-striped table-bordered dataTable" GridLines="None" OnRowCommand="gvUsuario_RowCommand" OnPreRender="gvUsuario_PreRender" >
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="nom_usuario" HeaderText="Nombre de usuario"/>
                                    <asp:BoundField DataField="nom_user" HeaderText="Nombre de Ingreso" />
                                    <%--<asp:BoundField DataField="pass_user" HeaderText="Contraseña" />--%>
                                    <asp:BoundField DataField="estado"  HeaderText="Estado" Visible="true" />
                                    <asp:BoundField DataField="perfil" HeaderText="Perfil" Visible="true"  />
                                    <asp:BoundField DataField="estado_pwd" HeaderText="Estado Contraseña" Visible="true"  />
                                    <asp:BoundField DataField="id_empleado" HeaderText="ID Empleado" />
                                    <asp:BoundField DataField="Empleado" HeaderText="Empleado" />
                                    <asp:BoundField DataField="cod_jefatura" HeaderText="ID Jefatura" />
